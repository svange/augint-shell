...
These notes extend the shared institutional notes for service, web, API, and backend repositories.
...
- Merge-commit-only policy applies; do not squash promotions.
